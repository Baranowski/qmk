...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_4x8_10(
        KC_ESC,  KC_1,    KC_2,    KC_3,                      KC_6,    KC_7,    KC_8,    KC_9,   
        KC_TAB,  KC_Q,    KC_W,    KC_E,                      KC_Y,    KC_U,    KC_I,    KC_O,   
        KC_TAB,  KC_A,    KC_S,    KC_D,                      KC_H,    KC_J,    KC_K,    KC_O,
        KC_LSFT,          KC_Z,    KC_X,                      KC_B,    KC_N,    KC_M,    KC_COMM,
