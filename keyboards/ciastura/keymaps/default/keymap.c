...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [l_num] = LAYOUT_4x8_10(
                 KC_PLUS, KC_LCBR, KC_RCBR,                   KC_7,    KC_8,    KC_9,
    ...
    [l_special] = LAYOUT_4x8_10(
        ...
        XXXXXXX, KC_F4,   KC_F5,   KC_F6,                     KC_HOME, KC_INS,  KC_PSCR, XXXXXXX,
        XXXXXXX, KC_F7,   KC_F8,   KC_F9,                     XXXXXXX, XXXXXXX, XXXXXXX, KC_END,
